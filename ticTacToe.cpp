// Tic Tac Toe is an Entry Level yet exiting project on which i guided my students so they can get a grasp on the language 
...
int x, y, p, r = 0, w = 0, i = 1, menu1, menu2, menu3, menu4;
string opinion;
